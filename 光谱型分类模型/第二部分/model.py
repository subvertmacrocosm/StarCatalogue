...
class StarNet(torch.nn.Module):
    def __init__(self):
        ...
        self.model_blue = torch.nn.Sequential(
            torch.nn.Conv1d(1, 32, 3, 2, padding=1),
            torch.nn.MaxPool1d(2),
            torch.nn.ReLU(),
            torch.nn.Conv1d(32, 32, 7, 2, padding=3),
            torch.nn.MaxPool1d(2),
            torch.nn.ReLU(),
...
if __name__ == '__main__':
    detect = StarNet()
    input_blue = torch.ones((16, 1, 2000))
    input_red = torch.ones((16, 1, 1000))
